...
import com.mclegoman.viewpoint.client.screen.config.april_fools_prank.PerspectiveAprilFoolsPrankConfigScreen;
import com.mclegoman.viewpoint.client.screen.config.experimental.PerspectiveExperimentalConfigScreen;
import com.mclegoman.viewpoint.client.screen.config.hold_perspective.PerspectiveHoldPerspectiveConfigScreen;
import com.mclegoman.viewpoint.client.screen.config.information.PerspectiveInformationScreen;
import com.mclegoman.viewpoint.client.screen.config.more_options.PerspectiveMoreOptionsConfigScreen;
import com.mclegoman.viewpoint.client.screen.config.shaders.PerspectiveShadersConfigScreen;
import com.mclegoman.viewpoint.client.screen.config.textured_entity.PerspectiveTexturedEntityConfigScreen;
import com.mclegoman.viewpoint.client.screen.config.zoom.PerspectiveZoomConfigScreen;
