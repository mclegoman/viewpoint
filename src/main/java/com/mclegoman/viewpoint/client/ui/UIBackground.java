...
public class UIBackground {
	...
	public static void init() {
		...
		registerUIBackground(new UIBackgroundData.Builder(Identifiers.GAUSSIAN).shaderId(Identifier.of(Data.getVersion().getID(), "shaders/post/gaussian.json")).build());
		registerUIBackground(new UIBackgroundData.Builder(Identifiers.LEGACY).renderWorld(context -> {
				...
				context.drawTexture(getUiBackgroundTextureFromConfig(), 0, 0, 0, 0.0F, ClientData.minecraft.getWindow().getScaledWidth(), ClientData.minecraft.getWindow().getScaledHeight(), 32, 32);
				context.drawTexture(Identifier.of(Data.getVersion().getID(), "textures/gui/uibackground_menu_background.png"), 0, 0, 0, 0.0F, ClientData.minecraft.getWindow().getScaledWidth(), ClientData.minecraft.getWindow().getScaledHeight(), 32, 32);
		...
		registerUIBackground(new UIBackgroundData.Builder(Identifiers.CLASSIC).renderWorld(context -> {
				...
				context.drawTexture(getUiBackgroundTextureFromConfig(), 0, 0, 0.0F, 0.0F, ClientData.minecraft.getWindow().getScaledWidth(), ClientData.minecraft.getWindow().getScaledHeight(), 32, 32);
				context.drawTexture(Identifier.of(Data.getVersion().getID(), "textures/gui/uibackground_menu_background.png"), 0, 0, 0, 0.0F, ClientData.minecraft.getWindow().getScaledWidth(), ClientData.minecraft.getWindow().getScaledHeight(), 32, 32);
