...
import com.mclegoman.viewpoint.client.screen.developmentwarning.PerspectiveDevelopmentWarningScreen;
import com.mclegoman.viewpoint.client.screen.downgradewarning.PerspectiveDowngradeWarningScreen;
import com.mclegoman.viewpoint.client.shaders.PerspectiveShaderDataLoader;
...
public class PerspectiveConfigHelper {
    ...
    public static void init() {
        try {
            ...
            PerspectiveData.LOGGER.warn("{}Failed to initialize config: {}", PerspectiveData.PREFIX, error.getLocalizedMessage());
        }
    }
